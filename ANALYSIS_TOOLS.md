...
_results/
└── _playground/
    ├── hierarchical_history.pkl    # Required
    ├── hierarchical_history.npz    # Optional fallback
    ├── config_simulation.txt
    └── emergence_evolution.png     # Generated by simulation
```
...
├── overview_analysis.png         # Main overview dashboard
├── condensation_analysis.png     # Condensation timeline
├── scales_analysis.png           # Per-scale breakdown
└── updates_analysis.png          # Update statistics
```
